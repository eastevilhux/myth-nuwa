...
public class SpaceTextWatcher implements TextWatcher {
    ...
    private SpaceWatcherListener spaceWatcherListener;
    ...
    public void afterTextChanged(Editable s) {
        if (isChanged) {
            ...
            updateContext(s,str);
            isChanged = false;
            if(spaceWatcherListener != null){
                spaceWatcherListener.afterTextChanged(str);
            }
        }
    }
    ...
    private void updateContext(Editable editable,String values) {
        if (spaceType == SpaceType.IDCARD_NUMBER_TYPE) {
    ...
    public void setSpaceType(SpaceType spaceType) {
        ...
        if (this.spaceType  == SpaceType.IDCARD_NUMBER_TYPE) {
    ...
    public SpaceWatcherListener getSpaceWatcherListener() {
        return spaceWatcherListener;
    }

    public void setSpaceWatcherListener(SpaceWatcherListener spaceWatcherListener) {
        this.spaceWatcherListener = spaceWatcherListener;
    }
    ...
    public interface SpaceWatcherListener{
