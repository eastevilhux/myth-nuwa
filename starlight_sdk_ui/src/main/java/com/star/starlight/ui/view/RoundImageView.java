...
public class RoundImageView extends AppCompatImageView {
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        type = a.getInt(R.styleable.RoundImageView_lyn_type, TYPE_OVAL);
        mBorderColor = a.getColor(R.styleable.RoundImageView_lyn_border_color, Color.WHITE);
        mBorderWidth = a.getDimension(R.styleable.RoundImageView_lyn_border_width, 0);
        mCornerRadius = a.getDimension(R.styleable.RoundImageView_lyn_corner_radius, dp2px(10));
        mLeftTopCornerRadius = a.getDimension(R.styleable.RoundImageView_lyn_leftTop_corner_radius, 0);
        mLeftBottomCornerRadius = a.getDimension(R.styleable.RoundImageView_lyn_leftBottom_corner_radius, 0);
        mRightTopCornerRadius = a.getDimension(R.styleable.RoundImageView_lyn_rightTop_corner_radius, 0);
        mRightBottomCornerRadius = a.getDimension(R.styleable.RoundImageView_lyn_rightBottom_corner_radius, 0);
